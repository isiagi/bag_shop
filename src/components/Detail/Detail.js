        ...
        <div className="detail__set">
          ...
          <div style={{ marginTop: "20px" }}>
            ...
            <div className="detail__preview">
              <p>
                <em>I found this bag to be the best of kind and I deeply love it</em>
              </p>
            </div>
          ...
          <h2>SUBMIT YOUR PREVIEW</h2>
            <form>
              ...
              <textarea placeholder="Enter Preview Here"></textarea><br />
              <button type="submit" style={{background: 'orange', color: 'white'}}>Submit Preview</button><br />
            </form>
          </div>
        </section>
